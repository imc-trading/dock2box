...
myopts="mac quiet splash video debug dma modules usbdelay blacklist server"
...
[ -z "$KOPT_server" ] && KOPT_server="dock2box:2379"
/usr/bin/client --endpoints $KOPT_server
on_exit_shell
